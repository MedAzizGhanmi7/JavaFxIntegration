...
public class CreateAccountController implements Initializable {
    ...
    @FXML
    private ComboBox<String> loginAsOptions;
    @FXML
    ...
    @FXML
    private Label experienceLabel2;
    @FXML
    private TextArea bioTextArea;
    @FXML
    private Label bioLabel;
    @FXML
    private Label bioLabel1;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ObservableList<String> items = FXCollections.observableArrayList("student", "instructor");
        loginAsOptions.setItems(items);
        loginAsOptions.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                if ("instructor".equals(newValue)) {
                    experienceField.setVisible(true);
                    bioTextArea.setVisible(true);
                    bioLabel.setVisible(true);
                    bioLabel1.setVisible(true);
                    experienceLabel.setVisible(true);
                    experienceLabel2.setVisible(true);
                } else {
                    experienceField.setVisible(false);
                    bioTextArea.setVisible(false);
                    experienceLabel.setVisible(false);
                    experienceLabel2.setVisible(false);
    ...
    private void CreateAcc(ActionEvent event) {
        String selectedUserType = loginAsOptions.getSelectionModel().getSelectedItem();
        ...
        if (selectedUserType == null || selectedUserType.isEmpty()) {
            typeErrorLabel.setText("Please select a user type");
        ...
        if ("student".equals(selectedUserType)) {
            if (majorField.getText().isEmpty()) {
                generalErrorLabel.setText("Please enter your major.");
                generalErrorLabel.setVisible(true);
                return;
            }

            if (gradeField.getText().isEmpty()) {
                generalErrorLabel.setText("Please enter your current grade level.");
                generalErrorLabel.setVisible(true);
                return;
            }
            ...
            student.setDateOfBirth(Date.valueOf(dateOfBirth.getValue()));
            student.setFirstName(firstName.getText());
            student.setLastName(lasttName.getText());
            student.setAddress(address.getText());
            student.setProfilePicture(selectedImageData); // Store the image as a BLOB
            student.setMajor(majorField.getText());
            student.setCurrentGradeLevel(gradeField.getText());
            student.setPhoneNumber(selectedCountry + " " + phoneNumber.getText());
            Toggle selectedToggle = toggleGroup.getSelectedToggle();
            if (selectedToggle != null) {
                RadioButton selectedRadioButton = (RadioButton) selectedToggle;
                String selectedValue = selectedRadioButton.getText();
                student.setGender(selectedValue);
            }
            studentService.create(student);
            sendAccountCreationEmail(email.getText(), "Student");
        } else if ("instructor".equals(selectedUserType)) {

            if (experienceField.getText().isEmpty()) {
                generalErrorLabel.setText("Please enter the years of experience.");
                generalErrorLabel.setVisible(true);
                return;
            }
            ...
            try {
                yearsOfExperience = Integer.parseInt(experienceField.getText());
            ...
            if (bioTextArea.getText().isEmpty()) {
                generalErrorLabel.setText("Please enter your bio.");
                generalErrorLabel.setVisible(true);
                return;
            }

            Instructor instructor = new Instructor();
            instructor.setRegistrationDate(new Date(System.currentTimeMillis()));
            instructor.setUsername(username.getText());
            instructor.setPassword(password.getText());
            instructor.setEmail(email.getText());
            instructor.setDateOfBirth(Date.valueOf(dateOfBirth.getValue()));
            instructor.setFirstName(firstName.getText());
            instructor.setLastName(lasttName.getText());
            instructor.setAddress(address.getText());
            instructor.setProfilePicture(selectedImageData); // Store the image as a BLOB
            instructor.setYearsOfExperience(Integer.parseInt(experienceField.getText()));
            instructor.setBio(bioTextArea.getText());
            instructor.setPhoneNumber(selectedCountry + " " + phoneNumber.getText());
            Toggle selectedToggle = toggleGroup.getSelectedToggle();
            if (selectedToggle != null) {
                RadioButton selectedRadioButton = (RadioButton) selectedToggle;
                String selectedValue = selectedRadioButton.getText();
                instructor.setGender(selectedValue);
            }
            instructorService.create(instructor);
            sendAccountCreationEmail(email.getText(), "Instructor");
        }
    }
