...
public class ChapitreQuizz { // the format in DB: q1|q2 a11,a12,a13|a21 etc..
            ...
            String delimitedString, String delimitedAnswers, String delimitedCorrectAnswers)
    {
        ...
        for(int i = 0; i<questions.length; i++)
        {
            ...
            ChapitreQuizzQuestion q = new ChapitreQuizzQuestion();
            q.setText(questionText);
            String[] a = answers[i].split(",");
            String[] b = correctAnswers[i].split(",");
            for(int j = 0; j<a.length; j++)
            {
                ...
                ChapitreQuizzAnswer aa = new ChapitreQuizzAnswer();
